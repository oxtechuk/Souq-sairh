                ...
                <tbody class="border-top-0">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge bg-info-subtle text-info px-3 py-2 rounded-pill small fw-bold">{{ $emp->role }}</span>
                        </td>
                        <td class="text-center">
                                    ...
                                    <div class="modal-body p-4 pt-2">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="role" class="form-select bg-light border-0 shadow-none" required>
                                                <option value="" disabled>{{ __('اختر الصلاحية') }}</option>
                                                @foreach($roles as $role)
                                                    <option value="{{ $role->name }}" {{ $emp->role === $role->name ? 'selected' : '' }}>{{ $role->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-3">
            ...
            <form action="{{ route('crm.employees.store') }}" method="POST">
                ...
                <div class="modal-body p-4 pt-2">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role" class="form-select bg-light border-0 shadow-none" required>
                            <option value="" disabled selected>{{ __('اختر الصلاحية') }}</option>
                            @foreach($roles as $role)
