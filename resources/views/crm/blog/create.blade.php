            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card border-0 shadow-sm mb-4 rounded-4 bg-primary text-white overflow-hidden">
                    <div class="card-body p-4 position-relative">
                        ...
                        <h6 class="mb-3 fw-bold">{{ __('إعدادات النشر') }}</h6>
                        
                        <div class="form-check form-switch mb-3 p-3 bg-white bg-opacity-10 rounded-3 border-0">
                            ...
                            <label class="form-check-label fw-bold ms-2" for="isPublished">{{ __('نشر المقالة فوراً') }}</label>
                        </div>
                        <div class="form-check form-switch p-3 bg-white bg-opacity-10 rounded-3 border-0">
                            ...
                            <label class="form-check-label fw-bold ms-2" for="isFeatured">{{ __('مميزة (تظهر في قسم المقالات المميزة)') }}</label>
                        </div>
                        
                        @can('blog.create')
                        <button type="submit" class="btn btn-white w-100 py-3 fw-black text-primary border-0 rounded-3 shadow-sm">
                            <i class="bi bi-save2 me-1"></i> {{ __('حفظ المقالة الآن') }}
                        </button>
                        @endcan
                    </div>
                </div>
