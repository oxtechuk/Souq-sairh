...
@section('title', __('إضافة سيارة جديدة') . ' | Souq Siarh')
                ...
                <div class="car-section mb-4">
                    ...
                    <div class="car-section-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">بالإنجليزية <span class="text-danger">*</span></label>
                                <input type="text" name="name[en]" class="form-control @error('name.en') is-invalid @enderror"
                                       value="{{ old('name.en') }}" placeholder="e.g. Toyota Camry" required dir="ltr">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="description[en]" class="form-control" rows="3" dir="ltr" placeholder="Car description...">{{ old('description.en') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="car-section-body">
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="specs[hp]" class="form-control" placeholder="300 HP" value="{{ old('specs.hp') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">{{ __('نوع الوقود') }}</label>
                                <input type="text" name="specs[fuel]" class="form-control" placeholder="بنزين / كهربائي" value="{{ old('specs.fuel') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">{{ __('ناقل الحركة') }}</label>
                                <input type="text" name="specs[gearbox]" class="form-control" placeholder="أوتوماتيك" value="{{ old('specs.gearbox') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">{{ __('عدد المقاعد') }}</label>
                                <input type="number" name="specs[seats]" class="form-control" placeholder="5" value="{{ old('specs.seats') }}">
                            </div>
                        </div>
                            <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="car-img-drop" id="thumb-drop" onclick="document.getElementById('thumbnailInput').click()">
                                    ...
                                    <small class="d-block text-muted">JPG, PNG, WebP — حد أقصى 5MB</small>
                                </div>
...
function addColorRow(name = '', hex = '#1a3163', imgSrc = '') {
