    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        toggleBtn.addEventListener('click', function() {
            ...
            if (showingUntranslated) {
                ...
                this.innerHTML = '<i class="bi bi-eye-fill me-1"></i> عرض الكل <span class="badge bg-light text-dark ms-1">' + countSpan.textContent + '</span>';
            } else {
                this.classList.remove('btn-success');
                this.classList.add('btn-warning');
                this.innerHTML = '<i class="bi bi-funnel-fill me-1"></i> الغير مترجم فقط <span class="badge bg-light text-dark ms-1">' + countSpan.textContent + '</span>';
            }
            filterRows();
        });
        ...
        addBtn.addEventListener('click', function() {
            ...
            tr.innerHTML = `
                ...
                <td class="p-0">
                    <input type="text" name="en_values[]" class="form-control border-0 shadow-none px-4 py-3 bg-transparent seamless-input" placeholder="English text" dir="ltr">
                </td>
                <td class="p-0">
                    <input type="text" name="ar_values[]" class="form-control border-0 shadow-none px-4 py-3 bg-transparent seamless-input" placeholder="نص عربي" dir="rtl">
                </td>
                <td class="text-center">
                    <button type="button" class="btn btn-sm text-danger remove-row-btn" title="حذف الكلمة">
                        <i class="bi bi-trash"></i>
                    </button>
                </td>
            `;
