...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .btn-crm-outline { background: transparent; color: var(--crm-red); border: 2px solid var(--crm-red); border-radius: 12px; padding: 9px 20px; font-weight: 800; font-size: 13px; font-family: 'Cairo', sans-serif; cursor: pointer; transition: 0.2s; display: inline-flex; align-items: center; gap: 8px; text-decoration: none; }
